...
define("SITE_NAME", "Enigma");  // Name of the site

// Path to the site with slash at the end  !!!!!!Important!!!!!!!!!!
/* Example: http://www.example.com/application/ */
define("SITE_PATH","http://www.theta12.in/quiz/");

define("ADMIN_NAME", "Sibi"); // Name of the administrator
define("ADMIN_EMAIL", "sibi@psibi.in"); // Email of the administrator
...
define("LOGIN_REDIRECT", "user/forms.php");
define("LOGOUT_REDIRECT", "user/login.php"); // Redirect the user to this page after logout
...
define("DB_NAME","theta12i_log"); // Database
define("DB_USER","theta12i_sibi"); // Username
define("DB_PASS","sibitheta"); // Password
...
define("SESSION_TIMEOUT", 60*6*60*60); // User timeout in seconds. 0 to disable timeout
